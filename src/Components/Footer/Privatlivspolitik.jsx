const Privatlivspolitik = () => (
    <div>
      <h1>Cookie- og privatlivspolitik hos AGUA TOTALINTERPRISE</h1>
      <h2>Introduktion</h2>
      <p>
      ...
      <p>
        Det er muligt at slette eller blokere for cookies. Se vejledning: <a href="http://minecookies.org/cookiehandtering">http://minecookies.org/cookiehandtering</a>
      </p>
      <p>
      ...
      <p>
        AGUA TOTALINTERPRISE<br />
        Østerhøjvej 28<br />
        2750 Ballerup<br />
        Telefon: 28 49 34 81<br />
        Email: <a href="mailto:ismaellimonta@outlook.dk">ismaellimonta@outlook.dk</a>
      </p>
    </div>
  );
