  ...
  return (
    <div className='about'>
        ...
        <div className='about-right'>
            <h3>Om AGUA TOTALINTERPRISE</h3>
            <h2>Din pålidelige partner til VVS, murer- og tømrerarbejde</h2>
            <p>Hos Agua Total Entreprise er vi din totalleverandør, når det gælder kvalitetsarbejde til hjem og erhverv. Vi kombinerer ekspertise inden for VVS, murer- og tømrerfaget for at sikre, at dine projekter bliver løst hurtigt, effektivt og med den højeste faglige standard.</p>
